...
const getManager = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({
            message: `Error receiving Manager: ${error === null || error === void 0 ? void 0 : error.message}`
        });
    }
});
...
const createManager = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({
            message: `Error creating Manager: ${error === null || error === void 0 ? void 0 : error.message}`
        });
    }
});
...
const updateManager = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({
            message: `Error updating Manager: ${error === null || error === void 0 ? void 0 : error.message}`
        });
    }
});
