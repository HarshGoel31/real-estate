...
const getTenant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({
            message: `Error receiving Tenant: ${error === null || error === void 0 ? void 0 : error.message}`
        });
    }
});
...
const createTenant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({
            message: `Error creating Tenant: ${error === null || error === void 0 ? void 0 : error.message}`
        });
    }
});
...
const updateTenant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({
            message: `Error updating Tenant: ${error === null || error === void 0 ? void 0 : error.message}`
        });
    }
});
...
const getCurrentResidences = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(500).json({ message: `Error retrieving tenant properties: ${err.message}` });
    }
});
